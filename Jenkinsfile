pipeline {
    ...
    stages {
        ...
        stage('Checkout') {
            steps {
                echo "-=- Checkout (recuperation) project -=-" 
                git url: 'https://github.com/Ngit11/Spring-Boot-Hello-World-Example.git'
                 ...
                 transfers: [
                  sshTransfer(
                   ...
                   execCommand: """
                    ...
                    docker tag springbootapp1 nodocker9/springbootapp1:1.0
                    docker push nodocker9/springbootapp1:1.0 """
                  )
                 ])
               ])
             }
                 ...
                 transfers: [
                  sshTransfer(
                   ...
                   execCommand: """
                    ...
                    sudo docker run -d -p 8080:8080 nodocker9/springbootapp1:1.0; """ 
                  )
                 ])
               ])
             }
